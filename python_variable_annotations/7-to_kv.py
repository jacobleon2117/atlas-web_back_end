...
def to_kv(k: str, v: Union[int, float]) -> Tuple[str, float]:
    """
    Create a tuple where the first element is a string and the 
    second element is the square of a number.

    Args:
        k (str): A string to be the first element of the tuple.
        v (Union[int, float]): An integer or float to be squared and
